...
import { checkout, verifyPayment, getMyOrders, getAllOrders, getOrderByIdForAdmin, updateOrderStatus } from '../controllers/orderController.js'; 
...
router.get('/:id', requireAuth, requireAdmin, getOrderByIdForAdmin);
